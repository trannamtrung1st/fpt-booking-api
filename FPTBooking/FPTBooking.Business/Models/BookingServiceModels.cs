...
namespace FPTBooking.Business.Models
{
    ...
    #region Query
    public class BookingServiceQueryProjection
    {
        ...
        private const string T = nameof(BookingService);
    }

    public class BookingServiceQuerySort
    {
    ...
    public class BookingServiceQueryFilter
    {
        public string code { get; set; }
        public string name_contains { get; set; }
    }

    public class BookingServiceQueryPaging
    {
        private int _page = 1;
        public int page
        {
    ...
    public class BookingServiceQueryOptions
    {
